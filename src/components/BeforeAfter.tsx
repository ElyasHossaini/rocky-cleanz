        ...
        <div className="relative max-w-4xl mx-auto">
          ...
          <div className="relative overflow-hidden rounded-2xl shadow-2xl bg-white">
            ...
            >
              ...
              {/* BEFORE Label - positioned outside the image container */}
              <div className="absolute top-4 left-4 bg-red-500 text-white px-4 py-2 rounded-lg font-semibold text-lg z-20">
                BEFORE
              </div>
